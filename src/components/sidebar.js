          ...
          <div className="widget_dropdown_wrap">
            ...
            >
              <div className="adress_wrap">
                ...
                <div className="definitions_wrap">
                  <h3>Head Office in Bhiwadi</h3>
                  <p>
                    {" "}
                    E-1098, Ajanta Chowk, Phase-III, RIICO Indl. Area,
                    Bhiwadi-301019 (Raj.)
                  </p>
                  <p>Phone: (+91) 7340695058</p>
                  <p>
                    <span>Email:</span>
            ...
            >
              <div className="short_contact">
                ...
                <p className="subtitle">
                  Are you seeking a trusted and reliable partner for your next
                  electrical project? Experience the Zeniya difference and let
                  us be the builder of choice for your next project.
                </p>
            ...
            >
              <div className="call_wrap">
                ...
                <p>
                  <a href="tel:18009876543">(+91) 7340695058</a>
                </p>
              </div>
            </div>
            <div
