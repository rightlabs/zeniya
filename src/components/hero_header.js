        ...
        <div className="glax_tm_swiper_content">
          <div className="container">
            <div className="swiper_content">
              <div className="texts_wrap">
                <h3>
                  Empowering Your Electrical Solutions with Innovation and
                  Efficiency
                </h3>
                <p>
                  Revolutionizing Industries with Cutting-Edge Electrical
                  Panels, Turnkey Projects & Solar Solutions - Pioneering
                  Innovation and Efficiency Since 2002, Providing Unparalleled
                  Excellence in Energy Solutions for a Sustainable Future.
                </p>
              </div>
